...
public class UpdateCustomer extends JFrame implements ActionListener{
    ...
    UpdateCustomer(String username){
        ...
        try{
            ...
            while(rs.next()){
                ...
                String gender = rs.getString("radio");
                if(gender == "Male"){
                    r2.setSelected(true);
                } else{
                    r1.setSelected(true);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
            ...
            String q = "update customer set username = '"+username+"', id = '"+id+"', number = '"+number+"', name = '"+name+"', radio = '"+gender+"', country = '"+country+"', address = '"+address+"', phone = '"+phone+"', email = '"+email+"' where username = '"+username+"'";
            try{
                conn c = new conn();
                c.s.executeUpdate(q);
